...
class Perplexity(Provider):
    def __init__(
        ...
        max_tokens: int = 600,
        timeout: int = 30,
        intro: str = "You are ChatEase, an emotionally intelligent ai developed by Divyansh Shukla. you always show emotions in form of emojis. You use so many emojis in your response and always try to give short and concise responses. also you can access internet if needed",
        filepath: str = None,
